...
# Bar chart for awareness of HPV causing Cervical cancer and education
g4 <- ggplot(data= na.omit(sub_hints_2020),aes(educa))
g4+ geom_bar(fill= "#809A6F")+
  facet_wrap(~hpvcausecancer_cervical)+
  coord_flip()+
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) +
  labs(title="Awareness of HPV causing Cervical Cancer ")+
...
CrossTable(sub_hints_2020$educa,sub_hints_2020$hpvcausecancer_cervical)
