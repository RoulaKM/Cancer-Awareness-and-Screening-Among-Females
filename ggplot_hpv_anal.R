...
# Bar chart for awareness of HPV causing Anal cancer and education
g5 <- ggplot(data= na.omit(sub_hints_2020),aes(educa))
g5+ geom_bar(fill= "#525E75")+
  facet_wrap(~hpvcausecancer_anal)+
  coord_flip()+
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) +
  labs(title="Awareness of HPV causing Anal Cancer ")+
...
CrossTable(sub_hints_2020$educa,sub_hints_2020$hpvcausecancer_anal)
