...
# Bar chart for awareness of HPV causing Penile cancer and education 
g3 <- ggplot(data= na.omit(sub_hints_2020),aes(educa))
g3+ geom_bar(fill= "#A25B5B")+
  facet_wrap(~hpvcausecancer_penile)+
  coord_flip()+
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) +
  labs(title="Awareness of HPV causing Penile Cancer ")+
...
CrossTable(sub_hints_2020$educa,sub_hints_2020$hpvcausecancer_penile)